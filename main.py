...
parameters = dict(epochs=300, batch_size=64, optimizer=Adam, learning_rate=0.004,
                  save_dir='./model_weights/cnn_ann')
# load_dir='./model_weights/new/c/0.005layers/25-1.931-0.465-1.677-0.510.hdf5')
