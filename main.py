...
smooth_factor = 0.1
rnn_shapes = dict(input_shape_1=(20, 120),
                  input_shape_2=(4, 24),
                  input_shape_3=(4, 32))
standardized = True
normalized = False
...
parameters = {'epochs': 50,
              ...
              'optimizer': Adam,
              'learning_rate': 0.005,
              'save_dir': f'./model_weights/ns/standardized_data/lstm/adam/{NUM_OF_CLASSES}',
              'num_classes': NUM_OF_CLASSES,
              'load_dir': f'./model_weights/ns/standardized_data/lstm/adam/{NUM_OF_CLASSES}/29-1.852-0.520-1.277-0.612.hdf5'}
