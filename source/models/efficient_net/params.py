...
IMAGENET_WEIGHTS = {
    ...
    'efficient_net-b0': {
        'name': 'efficient_net-b0_imagenet_1000.h5',
    ...
    'efficient_net-b0-notop': {
        'name': 'efficient_net-b0_imagenet_1000_notop.h5',
    ...
    'efficient_net-b1': {
        'name': 'efficient_net-b1_imagenet_1000.h5',
    ...
    'efficient_net-b1-notop': {
        'name': 'efficient_net-b1_imagenet_1000_notop.h5',
    ...
    'efficient_net-b2': {
        'name': 'efficient_net-b2_imagenet_1000.h5',
    ...
    'efficient_net-b2-notop': {
        'name': 'efficient_net-b2_imagenet_1000_notop.h5',
    ...
    'efficient_net-b3': {
        'name': 'efficient_net-b3_imagenet_1000.h5',
    ...
    'efficient_net-b3-notop': {
        'name': 'efficient_net-b3_imagenet_1000_notop.h5',
...
def efficientnet_params(model_name):
    """Get efficient_net params based on model name."""

    params_dict = {
        # (width_coefficient, depth_coefficient, resolution, dropout_rate)
        'efficient_net-b0': (1.0, 1.0, 224, 0.2),
        'efficient_net-b1': (1.0, 1.1, 240, 0.2),
        'efficient_net-b2': (1.1, 1.2, 260, 0.3),
        'efficient_net-b3': (1.2, 1.4, 300, 0.3),
        'efficient_net-b4': (1.4, 1.8, 380, 0.4),
        'efficient_net-b5': (1.6, 2.2, 456, 0.4),
        'efficient_net-b6': (1.8, 2.6, 528, 0.5),
        'efficient_net-b7': (2.0, 3.1, 600, 0.5),
    }
...
def efficientnet(width_coefficient=None,
    ...
    """Creates a efficient_net model."""
    blocks_args = [
        'r1_k3_s11_e1_i8_o8_se0.05', 'r2_k3_s22_e6_i16_o24_se0.25',
...
def get_model_params(model_name, override_params=None):
    ...
    if model_name.startswith('efficient_net'):
